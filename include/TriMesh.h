...
public:
	...
	AABB() {}
	AABB(const glm::vec3 &dimensions) : dimensions(dimensions) {}
	AABB(const glm::vec3 &location, const glm::vec3 &dimensions) : position(location), dimensions(dimensions) {}
...
public:
	...
	std::string mesh_name; // 物体的名称
	bool isTransparency = false;   // 是否透明
	AABB box;
};
